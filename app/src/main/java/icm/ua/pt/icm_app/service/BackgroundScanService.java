package icm.ua.pt.icm_app.service;
...
import icm.ua.pt.icm_app.MainActivity;
...
public class BackgroundScanService extends Service {
  ...
  private static final long TIMEOUT = TimeUnit.SECONDS.toMillis(100000);
  ...
  private IBeaconListener createIBeaconListener() {
    return new SimpleIBeaconListener() {
      ...
      public void onIBeaconDiscovered(IBeaconDevice ibeacon, IBeaconRegion region) {
        ...
        createNotification(ibeacon.getUniqueId());
      }
    };
  }
  ...
  public void createNotification(String beacon) {
    // Prepare intent which is triggered if the
    // notification is selected
    Intent intent = new Intent(this, MainActivity.class);
    intent.putExtra("notificationFragment",beacon);
    PendingIntent pIntent = PendingIntent.getActivity(this, (int) System.currentTimeMillis(), intent, 0);

    // Build notification
    // Actions are just fake
      Notification noti = new Notification.Builder(this)
              .setContentTitle("New exhibits around you!")
              .setContentText("Check them out!").setSmallIcon(R.drawable.logo)
              .setContentIntent(pIntent)
              //.addAction(R.drawable.current_expo, "Call", pIntent)
